...
export default function BottomNav() {
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 flex justify-around items-center py-3 px-2 shadow-[0_-2px_10px_rgba(0,0,0,0.05)]">
      {/* Home 按鈕 */}
      <button
        onClick={() => alert('主頁')}
      ...
      >
        ...
        <span className="text-[15px] font-medium text-[#1a1a1a] mt-1.5">
          Home
        </span>
      </button>
